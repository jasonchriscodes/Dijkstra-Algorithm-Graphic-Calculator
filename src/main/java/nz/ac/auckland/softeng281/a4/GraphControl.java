    ...
    public boolean processCommand(String command) {
        ...
        switch (parts[0]) {
            ...
            case "help":
                ...
                System.out.println("1. open a.txt -> to open a.txt file (see the file in resource)");
                System.out.println("2. search 2 -> to search the edge that has the weight of 2");
                System.out.println("3. search 5 3 -> to search the weight from source 5 to target 3 ");
                System.out.println("4. path 0 3 -> to search for the shortest path from 0 to 3 and the cost of it");
                break;
            case "list":
